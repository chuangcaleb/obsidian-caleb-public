`tags`:: 
`parents`:: [[Story-db Database]] - [[whatsthestoryabout]]

# Frozen 2 Rewrite

> Many forms of rewrites of the Frozen 2 movie that was so close, yet so very far.

`created`:: 03:08pm, [[2021-07-07|07 July 2021]]
`source`:: [F2 Rewrite Google Docs](https://docs.google.com/document/d/1MZKWkegyyvGFvyRAcahXhfmD-dE4LG-GbGaRsCyl7-s/edit?usp=sharing)

---

## F2R

The project started in 21 Dec 2019, after watching the movie twice in early December.
...
Once the First Draft was complete, I did a screen recording with handpicked soundtracks, scrolling through the sections according to the emotional dynamics of the music. I uploaded this to wtsa.
...
After discovering [Fountain | A markup language for screenwriting](https://fountain.io/), I needed a story to practice writing with. I also wanted to see the [[Frozen 2 Rewrite]] in screenplay format.

Starting on 30th May 2021, I started writing. I eventually set up a linktree and kept it in Google Drive for contstant updates.
